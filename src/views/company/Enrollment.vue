  ...
  <div>
      ...
      <div class="prev-next-button-container">
        <div class="button-container">
          <button>Back</button>
          <button v-if="isState === 'enrollment'" v-on:click="next">Next</button>
          <button v-if="isState === 'web'" v-on:click="employeeDetails">Next</button>
          <button v-if="isState === 'excel'" v-on:click="excel">Next</button>
        </div>
      </div>
  	</div>
