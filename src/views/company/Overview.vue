        ...
        <div class="column-2">
          <div class="company-credits-container mednefits-box">
            ...
            <div class="home-spending-type-container">
              ...
              <button @click="spendType(0, 'medical')" v-bind:class="{'active': spendingType.value === 0}" class="btn btn-medical">Medical</button>
              <button @click="spendType(1, 'wellness')" v-bind:class="{'active': spendingType.value === 1}" class="btn btn-wellness">Wellness</button>
            </div>
